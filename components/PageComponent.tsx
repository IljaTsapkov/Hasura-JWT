          ...
          >
            <div className="flex flex-col">
              ...
              <input
                ...
                type="email"
                name="email"
                className="indent-1 mb-2 appearance-none text-slate-900 w-60 min-[450px]:w-96 h-10 shadow-sm outline-none border-b border-black bg-white focus:border-black focus:border-b-[3px]"
              />
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                type="password"
                name="password"
                className="indent-1 mb-2 appearance-none text-slate-900 w-60 min-[450px]:w-96 h-10 shadow-sm outline-none border-b border-black bg-white focus:border-b-[3px]"
              />
              <div className="text-red-600 text-sm"></div>
            </div>
            <button
              type="submit"
              className="w-60 min-[450px]:w-96 h-12 mt-4 rounded-md bg-black text-white font-semibold text-lg hover:bg-white hover:bg-white hover:text-black hover:border-2 hover:border-black"
            >
              Log in
            </button>
          </form>
            ...
            {({
              ...
              >
                ...
                <button
                  ...
                  type="submit"
                  className="w-60 min-[450px]:w-96 h-12 mt-4 rounded-md bg-black text-white font-semibold text-lg hover:bg-white hover:text-black hover:border-2 hover:border-black"
                >
                  Register
                </button>
              </form>
